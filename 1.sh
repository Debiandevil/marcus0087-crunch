...
case $choice in
        1)      echo "U are sure so what we can do beginning the installer."
                bash kali-linux/h.sh
                exit 0
                ;;
        2)      echo "U are sure so what we can do beginning the installer."
                bash ubuntu/u.sh
                exit 0
                ;;
        3)      echo "U are sure so what we can do beginning the installer."
                bash Debian/d.sh
                exit 0
                ;;
        4)      echo "Yo beatch u don't even know about your OS."
