...
blue='\033[1;34m'
printf "$red"
echo "Due to latest repo updates zipalign is removed."
echo "So that's why i have to check for it."
sleep 1
echo "Checking whether zipalign is installed or not ......"
dpkg -s $1 &> /dev/null
if [ "$?" == "0" ]
then
echo "Zipalign..........installed.....$(sleep 2)...[yes]"
exit 0
else
echo "Zipalign...........installed.....$(sleep 2)...[no]"
fi
printf "$blue"
